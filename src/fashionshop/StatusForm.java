...
public class StatusForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        OrderIdTextField.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(OrderIdTextField, javax.swing.GroupLayout.PREFERRED_SIZE, 201, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(OrderIdTextField, javax.swing.GroupLayout.PREFERRED_SIZE, 52, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(StatusLabel, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 200, Short.MAX_VALUE))
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(SizeLabel, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(QtyLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 38, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGap(40, 40, 40)
    ...
    private void SearchButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SearchButtonActionPerformed
        // TODO add your handling code here:
        String searchOrderId = OrderIdTextField.getText();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
    if (order == null) {
        JOptionPane.showMessageDialog(null, "No order found. Please perform a search first.", "Status Change Error", JOptionPane.ERROR_MESSAGE);
        return;
    }
    ...
    if (currentStatus == 2) {
        JOptionPane.showMessageDialog(null, "Can't change this order status, Order is already delivered.", "Status Change Error", JOptionPane.ERROR_MESSAGE);
    } else if (currentStatus == 0) {
        Object[] options = {"Order Delivering", "Order Delivered"};
        int choice = JOptionPane.showOptionDialog(null,
                "Select the new status:", "Change Status", JOptionPane.DEFAULT_OPTION,
        ...
        StatusLabel.setText(getStatusString(order.getOrderStatus()));
    } else if (currentStatus == 1) {
        Object[] options = {"Order Delivered"};
        int choice = JOptionPane.showOptionDialog(null,
                "Select the new status:", "Change Status", JOptionPane.DEFAULT_OPTION,
                JOptionPane.QUESTION_MESSAGE, null, options, options[0]);
